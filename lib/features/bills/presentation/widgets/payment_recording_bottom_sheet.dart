...
class PaymentRecordingBottomSheet extends ConsumerStatefulWidget {
  ...
  static Future<void> show({
    ...
    return showModernBottomSheet(
      context: context,
      builder: (context) => PaymentRecordingBottomSheet(
        bill: bill,
...
class _PaymentRecordingBottomSheetState
  ...
  void _validateAccountBalance(List<Account> accounts) {
    ...
    if (selectedAccount.availableBalance < _amount) {
      final shortfall = _amount - selectedAccount.availableBalance;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ModernAmountDisplay(
                      ...
                      isEditable: true,
                      onTap: () {
                        // Amount editing handled by ModernAmountDisplay
                      },
                      onAmountChanged: (value) {
                        setState(() {
                          _amount = value;
                        });
                        // Re-validate balance when amount changes
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'After payment: ${selectedAccount.currency} ${(selectedAccount.availableBalance - _amount).toStringAsFixed(2)}',
                                          style: TextStyle(
                                            color: Theme.of(context)
                                                .colorScheme
                                                .onSurfaceVariant,
    ...
    try {
      ...
      if (_selectedAccountId != null) {
        ...
        final accountValidation =
            await validateAccount.callForPayment(_selectedAccountId!, _amount);
