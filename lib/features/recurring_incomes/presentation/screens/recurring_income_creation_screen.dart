...
/// Screen for creating a new recurring income
class RecurringIncomeCreationScreen extends ConsumerStatefulWidget {
  const RecurringIncomeCreationScreen({super.key});

  @override
  ConsumerState<RecurringIncomeCreationScreen> createState() => _RecurringIncomeCreationScreenState();
}

class _RecurringIncomeCreationScreenState extends ConsumerState<RecurringIncomeCreationScreen> {
