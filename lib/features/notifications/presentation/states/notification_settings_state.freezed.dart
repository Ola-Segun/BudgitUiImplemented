...
abstract class $NotificationSettingsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {NotificationSettings settings, bool isLoading, String? errorMessage});
}
...
class _$NotificationSettingsStateImpl extends _NotificationSettingsState {
  const _$NotificationSettingsStateImpl(
      {required this.settings, required this.isLoading, this.errorMessage})
      : super._();
  ...
  @override
  String toString() {
    return 'NotificationSettingsState(settings: $settings, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
...
abstract class _NotificationSettingsState extends NotificationSettingsState {
  const factory _NotificationSettingsState(
      ...
      final String? errorMessage}) = _$NotificationSettingsStateImpl;
